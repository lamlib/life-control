...
export class UsersService {
    ...
    async findOneInternalAccountByAccountId(accountId: number): Promise<InternalAccount> {
        try {
    ...
    async createInternalAccount(registerDTO: RegisterDTO, userRoleId: number): Promise<InternalAccount> {
        ...
        const status = await this._emailStatusRepository.findOneBy({id: EmailStatusEnum.UNVERIFIED});
